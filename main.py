...
st.set_page_config(page_title="Personal Medical Dignosis System",page_icon="1.png" )
# 
st.logo("1.png")
...
with col1:
    st.image("1.png",width=230)
with col2:
    st.title("Personal Medical Dignosis System",anchor=False)
    # st.write("")
# st.markdown("---")
st.text("The Personal Medical Diagnosis System is an AI-driven healthcare application designed to assist users in identifying potential medical conditions based on their symptoms. By leveraging Machine Learning (ML) and Data Science, the system analyzes user-inputted symptoms and provides possible diagnoses, risk assessments, and recommendations for further medical consultation.")
...
model_files = {
    # 'Diabetes Prediction': 'Models/diabetes_model.sav',
    # 'Heart Disease Prediction': 'Models/heart_disease_model.sav',
    # 'Parkinsons Prediction': 'Models/parkinsons_model.sav',
    # 'Lung Cancer Prediction': 'Models/lungs_disease_model.sav',
    # 'Hypo-Thyroid Prediction': 'Models/Thyroid_model.sav'
    
    'Diabetes': 'Models/diabetes_model.pkl',
    'Heart Disease': 'Models/heart_disease_model.pkl',
    'Parkinsons Disease': 'Models/parkinsons_model.pkl',
    'Lung Cancer': 'Models/lungs_disease_model.pkl',
    'Hypo-Thyroid': 'Models/thyroid_model.pkl'
}

# Load models dynamically
models = {}

for disease, file in model_files.items():
    if os.path.exists(file):  # Check if file exists before loading
        ...
        st.warning(f"Model file not found: {file}")

# Streamlit UI
st.sidebar.header("Disease Prediction")
disease_choice = st.sidebar.selectbox("Choose a disease to predict:", list(model_files.keys()))
...
if disease_choice == 'Diabetes':
    st.title('Diabetes')
    # st.markdown("[About](https://en.wikipedia.org/wiki/Diabetes)")
    ...
    # diab_prediction = models['Diabetes Prediction'].predict(input_data)
...
if disease_choice == 'Heart Disease':
    ...
    if st.button('Heart Disease Test Result'):
        heart_prediction = models['Heart Disease'].predict([[age, sex, cp, trestbps, chol, fbs, restecg, thalach, exang, oldpeak, slope, ca, thal]])
        heart_diagnosis = 'The person has heart disease' if heart_prediction[0] == 1 else 'The person does not have heart disease'
        st.success(heart_diagnosis)

# Parkinson's Prediction Page
if disease_choice == "Parkinsons Disease":
    ...
    if st.button("Parkinson's Test Result"):
        parkinsons_prediction = models['Parkinsons Disease'].predict([[fo, fhi, flo, Jitter_percent, Jitter_Abs, RAP, PPQ, DDP, Shimmer, Shimmer_dB, APQ3, APQ5, APQ, DDA, NHR, HNR, RPDE, DFA, spread1, spread2, D2, PPE]])
        parkinsons_diagnosis = "The person has Parkinson's disease" if parkinsons_prediction[0] == 1 else "The person does not have Parkinson's disease"
        st.success(parkinsons_diagnosis)

# Lung Cancer Prediction Page
if disease_choice == "Lung Cancer":
    ...
    if st.button("Lung Cancer Test Result"):
        lungs_prediction = models['Lung Cancer'].predict([[GENDER, AGE, SMOKING, YELLOW_FINGERS, ANXIETY, PEER_PRESSURE, CHRONIC_DISEASE, FATIGUE, ALLERGY, WHEEZING, ALCOHOL_CONSUMING, COUGHING, SHORTNESS_OF_BREATH, SWALLOWING_DIFFICULTY, CHEST_PAIN]])
...
if disease_choice == "Hypo-Thyroid":
    ...
    if st.button("Thyroid Test Result"):
        thyroid_prediction = models['Hypo-Thyroid'].predict([[age, sex, on_thyroxine, tsh, t3_measured, t3, tt4]])
